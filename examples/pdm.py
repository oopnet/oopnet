...
consumptions_at_J156_from_python_PDM, consumptions_at_J494_from_python_PDM = rpt.consumption['J156'], rpt.consumption['J494']
consumptions_at_J156_from_python_PDM.rename('PYTHON_PDM', inplace=True)
consumptions_at_J494_from_python_PDM.rename('PYTHON_PDM', inplace=True)

# Plot the results
fig = plt.figure(1)

for pos, nid, c_to_plot in \
        ((211, 'J156', (consumptions_at_J156_from_epanet, consumptions_at_J156_from_python_PDM)),
         (212, 'J494', (consumptions_at_J494_from_epanet, consumptions_at_J494_from_python_PDM))):
