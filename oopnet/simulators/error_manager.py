...
from oopnet.simulators.simulation_errors import get_error_list, EPANETSimulationError
...
class ErrorManager:
    ...
    def raise_errors(self):
        ...
        if self.found_errors:
            raise EPANETSimulationError(
                [err(msg, details) for err, msg, details in self.found_errors]
            )
